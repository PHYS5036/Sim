...
:fAction(Gun)
{
  fGunDir = new G4UIdirectory("/GammaLabMC/generator/");
  fGunDir->SetGuidance("PrimaryGenerator control");

  fSetInputCmd = new G4UIcmdWithAString("/GammaLabMC/generator/InputFile",this);
  ...
  fSetModeCmd = new G4UIcmdWithAnInteger("/GammaLabMC/generator/Mode",this);
  ...
  fSetSeedCmd = new G4UIcmdWithAnInteger("/GammaLabMC/generator/Seed",this);
