...
PhysicsListMessenger::PhysicsListMessenger(PhysicsList* pPhys)
  :fPPhysicsList(pPhys)
{   
  fPhysDir = new G4UIdirectory("/DoseProfileMC/physics/");
  fPhysDir->SetGuidance("physics control.");

  fGammaCutCmd = new G4UIcmdWithADoubleAndUnit("/DoseProfileMC/physics/setGCut",this);  
  ...
  fElectCutCmd = new G4UIcmdWithADoubleAndUnit("/DoseProfileMC/physics/setECut",this);  
  ...
  fProtoCutCmd = new G4UIcmdWithADoubleAndUnit("/DoseProfileMC/physics/setPCut",this);  
  ...
  fAllCutCmd = new G4UIcmdWithADoubleAndUnit("/DoseProfileMC/physics/setCuts",this);
  ...
  fPListCmd = new G4UIcmdWithAString("/DoseProfileMC/physics/addPhysics",this);
